...
const [searchTerm, setSearchTerm] = useState("");
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-green-400 via-white to-orange-400 animate-bg-wave p-6">
      <h1 className="text-6xl font-extrabold text-gray-900 mb-8 font-serif tracking-widest">
        Digital Library
      </h1>
